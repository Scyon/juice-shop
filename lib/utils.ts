...
import type { ChallengeCategory } from './config.types'
...
export function getChallengeEnablementStatus (challenge: Challenge,
  ...
  ChallengeCategories: ChallengeCategory[] = config.get<ChallengeCategory[]>('challenges.categories'),
  ...
  if (challenge?.category &&
      ChallengeCategories.some(cat => cat.category === challenge.category && !cat.enabled)) {
